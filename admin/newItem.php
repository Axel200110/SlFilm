	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="premiere_item.php" class="sidebar__nav-link "><i class="icon ion-ios-film"></i> <span>Premiere Items</span></a>
				</li>

				<li class="sidebar__nav-item">
					<a href="newItem.php" class="sidebar__nav-link sidebar__nav-link--active"><i class="icon ion-ios-film"></i> <span>New Items</span></a>
				</li>
	...
	?>
		...
		<div id="modal-delete-<?php echo $cat_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			...
			<div class="modal__btns">
				<a href="delNewItem.php?ID=<?php echo $cat_id; ?>" class="modal__btn modal__btn--apply" type="button">Delete</a>
		...
		<div id="modal-edit-<?php echo $cat_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			...
			<div class="modal__btns">
				<a href="EditNewItem.php?ID=<?php echo $cat_id; ?>" class="modal__btn modal__btn--apply" type="button">Edit</a>
				<button class="modal__btn modal__btn--dismiss" type="button">Dismiss</button>
			</div>
		</div>
