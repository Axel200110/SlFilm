...
if (isset($_POST['sub'])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'alexwirdow100@gmail.com'; // Replace with your Gmail address
        $mail->Password = 'zbfg lyew zjxl frfe'; // Replace with your Gmail App Password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Email settings
        $mail->setFrom('alexwirdow100@gmail.com', 'SLFilm Contact Form');
        $mail->addAddress('alexwirdow100@gmail.com'); // Replace with your Gmail address
        ...
        echo "<script>alert('Failed to send message. Mailer Error: {$mail->ErrorInfo}');</script>";
    }
}
?>
					...
					<div class="row">
						...
						<div class="col-12">
							...
							<ul class="contacts__list">
								<li><a href="tel:+94789479949">0789479949</a></li>
								<li><a href="mailto:alexwirdow100@gmail.com">SLFilm</a></li>
							</ul>
