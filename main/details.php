			...
			<section class="section section--details section--bg" data-bg="img/section/details.jpg">
				<div class="container">
					<div class="row">
							...
							<div class="card card--details">
								<div class="row">
									<div class="col-12 col-sm-5 col-md-4 col-lg-3 col-xl-5">
										...
										<a href="<?php echo $row['link']; ?>" class="card_trailer" style="color:white;"><i class="icon ion-ios-play-circle"></i>  Download</a>
									</div>
						...
						<div class="col-12 col-xl-6"><?php
// Assuming the YouTube video ID is stored in $row['movie_file']
$youtube_url = "https://www.youtube.com/embed/" . $row['movie_file'];
?>
...
<div class="video-container">
    ...
    <div class="video-link">
        <a 
            href="https://www.youtube.com/watch?v=<?php echo $row['movie_file']; ?>" 
            target="_blank" 
            class="watch-link">
            Watch Trailer
        </a>
...
<!-- Optional: Add some styling to improve appearance -->
<style>
    .video-container {
        text-align: center;
        margin: 20px 0;
